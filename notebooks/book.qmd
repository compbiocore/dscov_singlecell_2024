...
3.  Go to your home folder and make a folder called `dscov_singlecell_2024` (`cd ~` and `mkdir scrna_r_workshop_2023`), then type `pwd` to get the path to this folder.
